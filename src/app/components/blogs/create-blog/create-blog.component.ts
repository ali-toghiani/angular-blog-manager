...
export class CreateBlogComponent {
  isLoading = false;
  defaultImageURL =
    'https://images.unsplash.com/photo-1517048676732-d65bc937f952?w=700&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8cGVvcGxlJTIwYXQlMjB3b3JrfGVufDB8fDB8fHww';
  form = new FormGroup({
    title: new FormControl('', {
      validators: Validators.required,
      nonNullable: true,
    }),
    image_url: new FormControl(this.defaultImageURL, {
      validators: Validators.required,
      nonNullable: true,
    }),
    main_text: new FormControl('', {
      validators: Validators.required,
      nonNullable: true,
    }),
  });
